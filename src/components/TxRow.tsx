...
export function TxRow({ tx, onDeleted, onEdited }: { tx: Transaction; onDeleted: () => void; onEdited: () => void }) {
        ...
        <td className="px-4 py-2.5">
          {conf ? (
            ...
            <div className="flex gap-3">
              <button onClick={() => setEditing(true)} className="text-xs text-gray-600 hover:text-violet-400 transition-colors">Editar</button>
